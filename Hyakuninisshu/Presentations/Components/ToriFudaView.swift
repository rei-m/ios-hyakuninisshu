...
class ToriFudaView: UIView {
  ...
  private func setUpLineView(lineView: VerticalLabel) {
    ...
    case firstLineView:
      ...
      trailingAnchor.constraint(equalTo: lineView.trailingAnchor, constant: fontSize * 0.75)
        .isActive = true
    case secondLineView:
      lineView.topAnchor.constraint(equalTo: topAnchor, constant: fontSize * 2.3).isActive = true
      lineView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: fontSize * 0.75).isActive =
        true
    default:
