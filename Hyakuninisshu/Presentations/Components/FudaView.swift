...
@IBDesignable class FudaView: UIView {
    ...
    private func setUpLineView(lineView: VerticalLabel) {
        ...
        case firstLineView:
            ...
            lineView.leadingAnchor.constraint(equalTo: secondLineView.trailingAnchor, constant: 8).isActive = true
            lineView.text = "     "
        case secondLineView:
            lineView.topAnchor.constraint(equalTo: topAnchor, constant: fontSize * 3.1).isActive = true
            lineView.leadingAnchor.constraint(equalTo: thirdLineView.trailingAnchor, constant: 8).isActive = true
            lineView.text = "       "
        case thirdLineView:
        ...
        case fourthLineView:
            ...
            lineView.trailingAnchor.constraint(equalTo: thirdLineView.leadingAnchor, constant: -8).isActive = true
            lineView.text = "       "
        case fifthLineView:
            lineView.topAnchor.constraint(equalTo: topAnchor, constant: fontSize * 4.6).isActive = true
            lineView.trailingAnchor.constraint(equalTo: fourthLineView.leadingAnchor, constant: -8).isActive = true
            lineView.text = "       "
        default:
