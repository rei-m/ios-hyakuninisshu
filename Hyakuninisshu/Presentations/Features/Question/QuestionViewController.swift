...
protocol QuestionViewProtocol: AnyObject {
  ...
  func presentNextVC(
    questionNo: UInt8, kamiNoKu: DisplayStyleCondition, shimoNoKu: DisplayStyleCondition)
...
class QuestionViewController: UIViewController {
  ...
  // MARK: - Method
  func inject(
    questionCount: Int, animationSpeed: AnimationSpeedCondition,
    presenter: QuestionPresenterProtocol
  ) {
...
extension QuestionViewController: QuestionViewProtocol {
  ...
  func presentNextVC(
    ...
    vc.inject(
      presenter: presenter, material: correct, questionNo: questionNo, questionCount: questionCount,
      kamiNoKu: kamiNoKu, shimoNoKu: shimoNoKu, animationSpeed: animationSpeed)
